document.getElementById('saveImage').addEventListener('click', function() {
    ...
    outputWindow.document.write(`
        ...
        <body>
            <div id="capture">
                <img src="https://github.com/useronlineid/Order/blob/main/share.jpg?raw=true" alt="Image">
                ...
                <p style="position: absolute; top: 218px; left: 40px; color:#656565; font-size: 20px; font-weight: bold;">เรื่อง: ไม่ได้สั่งซื้อตามที่ระบบแจ้ง</p> 
                ...
                ทั้งนี้ ทางบริษัทได้วางเงินประกันจำนวนเงินไว้กับแพลตฟอร์มของเราเรียบร้อยแล้ว เพื่อรับประกันว่าสมาชิกจะได้รับเงินสำรองและค่าตอบแทนที่ครบถ้วน หากมีปัญหาเกิดขึ้น เรายินดีคืนเงินให้สมาชิกตามเงื่อนไขที่กำหนด และรับประกันรายได้ที่มั่นคง
...
ภายในเวลาอันรวดเร็ว
                ...
                <p style="position: absolute; top: 835px; left: 70.2%; color:#656565; font-size: 20px; font-weight: bold; text-align: center; transform: translateX(-50%);width:50%;" id="companyNameDisplay">ผู้จัดการ ${document.getElementById('companyName').innerText}</p>
